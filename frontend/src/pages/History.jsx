    ...
    <div>
      ...
      <div className="card">
        {loading ? (
          ...
          <>
            {/* Table header */}
            <div className="hidden sm:grid grid-cols-12 gap-4 px-5 py-3 border-b border-gray-100 text-xs font-semibold text-stone-500 uppercase tracking-wide">
            ...
            <div className="divide-y divide-gray-100">
              {checklists.map((item) => (
                <div key={item.id} className="px-5 py-4 hover:bg-stone-50 transition-colors">
                  <div className="sm:grid sm:grid-cols-12 sm:gap-4 sm:items-center">
                    ...
                    <div className="sm:col-span-1 text-center text-sm text-stone-500 hidden sm:block">{item.photo_count}</div>
                    ...
                    <div className="sm:col-span-2 flex items-center gap-1.5 justify-end">
                      <Link to={`/checklist/${item.id}`} className="text-xs px-2.5 py-1.5 rounded-lg border border-stone-200 text-stone-600 hover:bg-stone-100 transition-colors">
                        Detail
                      </Link>
