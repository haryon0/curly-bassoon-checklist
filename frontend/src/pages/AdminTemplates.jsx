    ...
    <div>
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-stone-900">Manajemen Template</h1>
            <p className="text-sm text-stone-500 mt-1">Buat, edit, dan hapus template checklist.</p>
          </div>
          {!showCreateForm && (
            <button
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-stone-300 rounded-lg p-6 text-center">
                ...
                <label htmlFor="pdf-input" className="cursor-pointer">
                  ...
                  <div className="text-xs text-stone-400 mt-1">Max 50MB</div>
                </label>
              </div>
            </div>
      ...
      {/* Templates List */}
      {loading ? (
        <div className="card p-12 text-center text-stone-400">Memuat template...</div>
      ) : templates.length === 0 ? (
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-xs text-stone-400">Kode: {t.code}</div>
                    {t.description && (
